...
//        System.out.println("name = " + name);
        ...
        sc.nextLine(); // 이걸 중간에 끼워넣으면 중간에 들어간 \n을 없앨 수 있음
        String w3 = sc.nextLine(); // \n을 만나면 버퍼 종료 (지금까지 받은 데이터를 모두 버퍼에서 제거하고 변수에 대입)
        System.out.println("w3 = " + w3);
        String w4 = sc.nextLine(); // 이건 입력을 대기하여 준다
        System.out.println("w4 = " + w4);

        // \n -> 일종의 문자임
        int i = sc.nextInt(); // 숫자로 알아서 변환되어서 받을 수 있음 -> 100 => 100\n => \n
        System.out.println("i = " + i);

        // 전체 줄을 인식
        String line = sc.nextLine();// 엔터까지 다 읽음
        System.out.println("개행 문자 감지" + sc.next());
